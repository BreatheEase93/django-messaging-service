...
# Куда перенаправлять пользователя после успешного входа (на главную/дашборд)
LOGIN_REDIRECT_URL = "dashboard:index"

# Куда перенаправлять пользователя, если он пытается зайти на закрытую страницу без авторизации
